...
export function ItemOptionsSheet({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-end justify-center bg-black/50 pb-[calc(48px+env(safe-area-inset-bottom,0px))] sm:items-center sm:pb-0"
      onClick={onClose}
    >
      <div
        className="flex max-h-[85dvh] w-full max-w-lg flex-col rounded-t-2xl bg-white shadow-xl sm:rounded-2xl"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 sm:space-y-5">
          {item.optionGroups.map((group) => {
            const groupName = getLocalizedName(group.names, locale, cfg.defaultLocale);
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2.5">
                          ...
                          <span
                            className={`flex h-5 w-5 items-center justify-center rounded-${isSingle ? "full" : "md"} border-2 ${
                              isSelected
