    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div role="dialog" aria-modal="true" aria-labelledby="change-password-title" className="mx-4 w-full max-w-md overflow-y-auto rounded-lg bg-white p-4 shadow-xl sm:p-6" style={{ maxHeight: "calc(100dvh - 2rem)" }}>
        <div className="mb-4 flex items-center justify-between">
          ...
          {!success && (
            <button onClick={handleClose} className="flex h-11 w-11 items-center justify-center rounded-md text-gray-500 hover:text-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500" aria-label={tCommon("close")}>
