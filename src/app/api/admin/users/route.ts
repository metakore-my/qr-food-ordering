...
export async function POST(req: NextRequest) {
  ...
  // An ADMIN with no permissions can reach nothing but the dashboard's
  // no-access panel — pointless to create. Require at least one permission at
  // creation. SUPERADMIN is exempt (it bypasses permission checks, so its
  // permissions are always stored empty). Field-keyed so the form highlights it.
